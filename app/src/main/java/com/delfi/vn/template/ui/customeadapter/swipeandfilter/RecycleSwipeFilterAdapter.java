package com.delfi.vn.template.ui.customeadapter.swipeandfilter;
...
public abstract class RecycleSwipeFilterAdapter<T, VH extends RecyclerView.ViewHolder>
        extends RecyclerSwipeAdapter<VH> implements Filterable {
    ...
    public RecycleSwipeFilterAdapter() {
        this.mObjects = new ArrayList<>();
    }

    public RecycleSwipeFilterAdapter(List<T> items) {
        this.mObjects = items;
    }

    public RecycleSwipeFilterAdapter(OnItemClickListener itemClickListener) {
        this.mObjects = new ArrayList<>();
    ...
    public void setDataListNoRefresh(List<T> items) {
        if (items == null)
            items = new ArrayList<>();
        mOriginalValues = new ArrayList<>(items);
    }
