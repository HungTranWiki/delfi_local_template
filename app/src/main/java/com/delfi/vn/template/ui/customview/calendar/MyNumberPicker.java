...
public class MyNumberPicker extends LinearLayout {
    ...
    private int mSelectedTextType = 0;
    ...
    public interface OnScrollListener {
         ...
         *                    {@link #SCROLL_STATE_IDLE}.
         */
        public void onScrollStateChange(MyNumberPicker view, @ScrollState int scrollState);
    }
    ...
    public MyNumberPicker(Context context, AttributeSet attrs, int defStyle) {
        ...
        mDividerBackground = attributes.getDrawable(R.styleable.NumberPicker_np_divider_background);
        ...
        Typeface mTypeface = ResourcesCompat.getFont(this.mContext, R.font.montserrat_regular);//attributes.getString(R.styleable.NumberPicker_np_typeface);
        //if(type != null)
            //mTypeface = Typeface.create(type, Typeface.NORMAL);

        int text_Type = attributes.getInt(R.styleable.NumberPicker_np_textType, 0);

        mSelectedTextType = Typeface.NORMAL;
        if(text_Type == 1)
            mSelectedTextType = Typeface.BOLD;
        else if(text_Type == 2)
            mSelectedTextType = Typeface.ITALIC;
        else if(text_Type == 3)
            mSelectedTextType = Typeface.BOLD_ITALIC;
        ...
        // input text
        mSelectedText = findViewById(R.id.tvTextNumberPicker);
...
//        }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        // draw the dividers
        if (showSelectorWheel && mDividerDrawable != null && mDividerBackground == null) {
            if (isHorizontalMode()) {
        ...
        if(mDividerBackground != null){
            mDividerBackground.setBounds(0, mTopDividerTop, getRight(), mBottomDividerBottom);
            mDividerBackground.draw(canvas);
        }
        ...
        for (int i = 0; i < selectorIndices.length; i++) {
            if (i == mWheelMiddleItemIndex) {
                ...
                Typeface mTypeface = ResourcesCompat.getFont(this.mContext, R.font.montserrat_semi_bold);
                ...
                if (mTypeface == null)
                    mSelectorWheelPaint.setTypeface(Typeface.create(Typeface.SANS_SERIF, Typeface.NORMAL));
                else
                    mSelectorWheelPaint.setTypeface(Typeface.create(mTypeface, Typeface.NORMAL));
            }
    ...
    public void onInitializeAccessibilityEvent(AccessibilityEvent event) {
        ...
        event.setClassName(MyNumberPicker.class.getName());
    ...
    private void setValueInternal(int current, boolean notifyChange) {
        //Log.i("setValueInternal", String.valueOf(current));
        if (mValue == current) {
            return;
        }
    ...
    private void ensureCachedScrollSelectorValue(int selectorIndex) {
        ...
        if (selectorIndex < mMinValue || selectorIndex > mMaxValue) {
            ...
            if (mDisplayedValues != null) {
                ...
                scrollSelectorValue = String.valueOf(selectorIndex);//formatNumber(selectorIndex);
            }
        }
    ...
    /**
     * Removes all pending callback from the msg queue.
     */
    ...
    /*public void setTypeface(Typeface typeface) {
        ...
        if (mTypeface != null) {
            ...
            mSelectedText.setTypeface(Typeface.SANS_SERIF);
            mSelectorWheelPaint.setTypeface(Typeface.SANS_SERIF);
        }
    }*/
